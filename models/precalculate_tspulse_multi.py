...
print("la inferencia Multi ahora se realiza de forma combinada durante ")
print("el entrenamiento en el script 'finetune_tspulse_multi.py'.")
print("")
print("Por favor, ejecuta 'python models/finetune_tspulse_multi.py' para ")
print("entrenar y generar las señales en 'data/tspulse_multi_signals.json'.")
