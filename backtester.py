...
STRATEGY_INFO = {
    ...
    "S11": {"type": "TIMESFM_PURE", "name": "Macro + TimesFM 200M AI Oracle (GPU Edition) - Ideal 0% Comisiones"},
    "S12": {"type": "TIMESFM_SMART", "name": "Macro + TimesFM Smart Hold (GPU Edition) - Ideal 0.4% Comisiones"},
    "S13": {"type": "TIMESFM_ADAPTIVE", "name": "Macro + TimesFM Adaptive Volatility (GPU Edition) - Rango Dinámico"},
}
...
for s_id, params in STRATEGY_INFO.items():
    ...
    if stype == "ROC_VOL":
        ...
        desc = "V11: Inteligencia Artificial Pura. Usa Google TimesFM ejecutado en tu GPU RTX 5070 para predecir los próximos 5 días de trading. Compra si espera > 1.5%. Optimizado para brokers sin comisiones."
        ...
        desc = "V12: Inteligencia Artificial Híbrida. Combina predicciones de IA con la media móvil de 50 días. Opera en modalidad 'Smart Hold' para minimizar operaciones. Optimizado para dominar Buy & Hold incluso pagando comisiones del 0.4%."
        inds = ["Google TimesFM", "SMA 50 Guardrail", "SPY Macro Crash Guard"]
        pine_active = "//@version=5\n// TradingView no soporta IA local."
    elif stype == "TIMESFM_ADAPTIVE":
        desc = "V13: Inteligencia Artificial Adaptativa. El pináculo de V10. Combina IA con Bandas de Bollinger y MFI. Adapta su stop-loss dinámicamente según la volatilidad del activo y hace Mean Reversion en pánicos."
